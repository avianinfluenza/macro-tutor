...
// @version      1.0.0
// @description  Tutor-T 강의 영상이 끝나면 다음 영상으로 이동하고 자동 재생합니다.
...
(function () {
  'use strict';
  const CONFIG = { delayMs: 1200, debug: false, nextSelectors: ['[aria-label*="다음"]', '[title*="다음"]', 'a[href*="lesson"]', 'a[href*="lecture"]', 'a[href*="course"]', 'button'] };
  ...
  function scan() { const video = document.querySelector('video'); if (video) attach(video); }
